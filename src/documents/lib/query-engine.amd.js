 ...
 *
 * https://github.com/mr47/query-engine-amd
...
(function(root, factory) {
    ...
    if (typeof exports !== 'undefined') {
        ...
        // Define as AMD:
        define("query-engine",["backbone"], factory);
    } else {
        // Just run it:
    ...
    var Criteria, Hash, Pill, Query, QueryCollection, queryEngine, util,
    ...
    if (Backbone == null) {
        ...
        QueryCollection = (function(_super) {
            ...
            QueryCollection.prototype.initialize = function(models, options) {
                var key, me, value, _ref;
                me = this;
                if (this.options == null) {
                    this.options = {};
                }
                _ref = Criteria.prototype;
                for (key in _ref) {
            ...
            QueryCollection.prototype.hasModel = function(model) {
                var exists, _ref, _ref1;
                model || (model = {});
                if ((model.id != null) && this.get(model.id)) {
                    exists = true;
                } else if ((model.cid != null) && ((_ref = (_ref1 = this._byCid) != null ? _ref1[model.cid] : void 0) != null ? _ref : this.get(model.cid))) {
                    exists = true;
                } else {
                    exists = false;
                }
    ...
    Query = (function() {
        ...
        Query.prototype.selectors = {
            ...
            'model': {
                test: function(opts) {
                    var _ref, _ref1;
                    return (((_ref = opts.modelValue) != null ? _ref.cid : void 0) || opts.modelValue) === (((_ref1 = opts.selectorValue) != null ? _ref1.cid : void 0) || opts.selectorValue);
                }
            },
            'collection': {
                test: function(opts) {
